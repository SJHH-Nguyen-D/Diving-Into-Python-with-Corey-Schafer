...
app.layout = html.Div([
    html.Div([
        ...
        *** A Generic Example of Crossfiltering Across Multiple Graphs ***

        Ultimately, this callback defines 3 figures as a function of the intersection of their 3 selections. Lassoing an area of points in one plot highlights the interestection of those selected points in the two other plots. These changes are highlighted via figure updates to the respective graphs.
        """)))
    ]),
    html.Div([
    html.Div(
